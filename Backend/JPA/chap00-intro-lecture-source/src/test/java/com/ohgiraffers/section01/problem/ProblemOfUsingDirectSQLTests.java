...
public class ProblemOfUsingDirectSQLTests {
    ...
    * */
    ...
    void testDirectInsertSql() throws SQLException {
        ...
        pstm.setInt(2, menu.getMenuPrice());
        pstm.setInt(3, menu.getCategoryCode());
        pstm.setString(4, menu.getOrderableStatus());
...
//            menu.setMenuPrice(resultSet.getInt("MENU_PRICE"));
    ...
    void testAssociationObject() throws SQLException {
        ...
        while(resultSet.next()){
            ...
            menuAndCategory.setMenuCode(resultSet.getInt("MENU_CODE"));
            menuAndCategory.setMenuName(resultSet.getString("MENU_NAME"));
            menuAndCategory.setMenuPrice(resultSet.getInt("MENU_PRICE"));
            menuAndCategory.setCategory(new Category(resultSet.getInt("CATEGORY_CODE"), resultSet.getString("CATEGORY_NAME")));
            menuAndCategory.setOrderableStatus(resultSet.getString("ORDERABLE_STATUS"));
    ...
    * */
    ...
    void testEquals() throws SQLException {
        ...
        ResultSet rSet1 = stm1.executeQuery(query);
        ...
        ResultSet rSet2 = stm2.executeQuery(query);
