...
public class Order {
    ...
    /* 설명. insert의 편리함을 위해 Order 개념인 OrderMenu엔티티까지 포함해서 필드를 작성한다.(insert 시 추가) */
    ...
    public Order(int orderCode, LocalDate orderDate, LocalTime orderTime, int totalOrderPrice) {
