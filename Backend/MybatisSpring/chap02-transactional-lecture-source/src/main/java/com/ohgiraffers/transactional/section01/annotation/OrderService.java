...
public class OrderService {
    ...
    * */
     ...
     *                   오염된 값 읽기 문제는 해결되지만 재현 불가능한 값 읽기 및 허상읽기는 여전히 발생할 수 있다.(다른 로우 수정및 추가는 막을 수 있다.)
...
//        System.out.println("menuCode = " + menuCode);
        ...
        /* 설명. 4-1. insert 하기 위해 테이블과 매칭되는 Entity로 옮겨 담는다.(DTO -> Entity) */
