...
/* 수업목표. 동적계획법(DynamicProgramming) 알고리즘을 활용하는 예제를 이해할 수 있다. */
/* 필기
 *  복잡한 전체 문제를 작은 부분 문제에 대한 최적의 해결방법을 고민하여 해결하는 알고리즘
...
public class Application1 {
    ...
    public static int solution(int N) throws Exception{
        ...
        /* 설명
         *  5kg까지는 앞의 if문에서 처리 했기 때문에 (5kg 이하는 1이 측정되어야 하므로 +1)
         *  6kg부터 dp배열에 저장한다.(3kg, 5kg개념을 해당 dp에 저장)
