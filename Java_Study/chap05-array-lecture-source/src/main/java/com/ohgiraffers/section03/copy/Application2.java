...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        print("clone()", copyArr2);

        /* 목차 3. arraycopy() */
        int[] copyArr3 = new int[originArr.length+3];
        System.arraycopy(originArr, 0, copyArr3, 3, originArr.length);
        print("arraycopy()", copyArr3);

        /* 목차 4. copyOf() */
        int[] copyArr4 = Arrays.copyOf(originArr, 2);    // 원본의 처음부터 원하는 길이까지 복사 가능
        print("copyOf()", copyArr4);



    }

    private static void print(String str, int[] arr) {           // originArr -> arr로 얕은 복사가 발생함
