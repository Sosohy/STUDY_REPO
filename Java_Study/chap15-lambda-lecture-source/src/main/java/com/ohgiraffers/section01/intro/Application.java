...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        /* 설명. 내부 인터페이스인 Sum의 하위 구현체에서 존재하는 메소드를 오버라이딩(람다식 활용) */
        ...
        OuterCaculator.Divide divide = (x, y) -> x / y;

        System.out.println("20+10 = " + sum.sumTwoNumber(20, 10));
        System.out.println("20-10 = " + minus.minusTwoNumber(20, 10));
        System.out.println("20*10 = " + multiple.multiplyTwoNumber(20, 10));
        System.out.println("20/10 = " + divide.divideTwoNumber(20, 10));
