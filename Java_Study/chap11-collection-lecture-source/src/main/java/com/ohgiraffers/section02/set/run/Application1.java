...
//        HashSet<String> hashSet = new HashSet<>();
        ...
        /* 설명. 중복값은 Set에 추가되지 않는다.(동등 객체 저장 안함) -> equals, hashCode 오버라이딩 필요 */
        /* 중복되는 값이 있으면 새로 추가하려는 객체의 주소가 튕겨 나간다.(덮어쓰지 않음) */
        System.out.println(hSet);

        /* 설명. 인덱스 개념이 없는 Set은 iterator(반복자)를 돌리거나 배열로 바꿔야 확인 가능 */
