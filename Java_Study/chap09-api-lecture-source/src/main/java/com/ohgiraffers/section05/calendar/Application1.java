...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("기준시간(1970년 0분 0초) : " + new Date(0L));

        /* 설명. 우리가 원하는 형태로 출력 -> SimpleDateFormat, long 타입 활용 */
        ...
        java.sql.Date sqlDate = new java.sql.Date(today.getTime());    // java.util.Date를 long형으로 변환해서 sql.Date로 변환
//        java.sql.Date sqlDate2 = (java.sql.Date)today;               // 실제로는 sql.Date형이었던 날짜형이 util.Date형인 today에 담겨있었으면 이 방법(다운캐스팅)도 가능
//                                                                     //java.sql.Date는 java.util.Date 상속 받음 
        
        /* 설명. java.sql.Date -> java.util.Date */
        java.util.Date utilDate = sqlDate;                             // 다형성이 적용됨
