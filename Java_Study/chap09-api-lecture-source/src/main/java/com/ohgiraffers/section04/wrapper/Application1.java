...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        // Object obj = (Object : up-Casting(다형성))(Integer : auto-Boxing)10;
        anythingMethod(10);            // Object obj = (Object)(Integer)10;

        /* 설명. Wrapper 클래스 값 비교 */
        /* 설명. Wrapper클래스들도 리터럴(literal) 값으로 오토박싱하면 결국 동일한 객체 하나만 관리된다. */
        Integer integerTest = (Integer) 30;
        Integer integerTest2 = (Integer) 30;
        System.out.println(" == 비교 : " + (integerTest == integerTest2));
//        System.out.println(" equals : " + (integerTest.equals(integerTest2)));
    ...
    /* 설명. 매개변수가 Object인 메소드(어떤 자료형의 전달인자이든 받아낼 수 있는 코드) */
    public static void anythingMethod(Object obj){  // 10 -> Integer(오토박싱) -> Object(다형성)
        System.out.println(obj);                    // Object의 toString()이 아닌 Integer의 toString()이 실행 됨(동적 바인딩)
    }
}
