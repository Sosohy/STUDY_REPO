...
public class LifecycleAnnotationTests {
    ...
    * */
    ...
    /* 테스트가 실행되기 전 딱 한번만 실행한다. */
    @BeforeAll
    public static void beforeAll(){
        System.out.println("beforeAll");
    }

    /* 각각의 테스트 메소드가 실행되기 전 실행되며, 주로 테스트 전에 필요한 목업 데이터를 미리 세팅해 줄 목적으로 사용된다. */
    @BeforeEach
    ...
    /* 각각의 테스트 메소드가 동작한 직후 동작한다. 주로 단위 테스트들이 수정된 이후 사용한 자원을 반납/해제할 목적으로 사용된다. */
    @AfterEach
