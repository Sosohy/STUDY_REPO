...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        Animal an3 = new Animal();    // 다형성 X -> 부모 자신의 타입은 다형성이 아님

        /* 설명. Animal은 Tiger나 Rabbit이 아니다. -> Animal은 Tiger Rabbit 타입을 지니고 있지 않다. */
//      Tiger t1 = new Animal();
//      Rabbit r1 = new Animal();
        ...
        * */
        ...
        /* 설명. 오버라이딩 되지 않은(자식이 추가한 메소드) 메소드 호출은 다운캐스팅을 해주어야 한다. */
        /* 필기
         *  instanceof 란?
         *  해당 객체의 타입을 런타임 시점에 확인하기 위한 연산자
        * */
        
        if(an1 instanceof Tiger)               // an1이 Tiger타입의 인스턴스인가
            ((Tiger)an1).bite();
