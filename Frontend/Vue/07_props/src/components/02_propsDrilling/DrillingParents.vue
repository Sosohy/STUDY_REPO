...
<!-- 
    ...
    vue에서는 필요한 부모 컴포넌트 하위의 컴포넌트에서 필요 시 inject하여 어디서든 사용할 수 있으면 이를 통해
...
// provide('count', readonly(count));   // provide를 활용하는 부모 컴포넌트에서는 수정하지만 injecct를 활용하는 곳은 읽기 전용으로 작성할 수 있다.(권장)
